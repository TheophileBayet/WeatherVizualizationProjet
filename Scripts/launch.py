...
def KML_ScriptGeneration(Iterations):
        ...
        script_kml.write("<name>France temperature informations at time "+ str(i) +" </name> \n")
        ...
        while i<NbrPrevisions+1 :
            ...
            script_kml.write("</TimeSpan> \n")
            script_kml.write("<name>France temperatures at time "+str(i)+"</name> \n")
            ...
            script_kml.write("<end>2017-11-"+str(16+i+1)+"</end>\n")
            script_kml.write("</TimeSpan> \n")
            script_kml.write("<name>France temperatures isovaleurs at time "+str(i)+" </name> \n")
            script_kml.write("<Icon> \n")
            ...
            script_kml.write("<end>2017-11-"+str(16+i+1)+"</end>\n")
            script_kml.write("</TimeSpan> \n")
            script_kml.write("<name>France wind streams at time "+str(i)+"</name> \n")
            script_kml.write("<Icon> \n")
